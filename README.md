...
title.Text = "ULTRA RTX HD V9 BY PABLO SCRIPTS"
...
print("ULTRA RTX HD V9 BY PABLO SCRIPTS - REALIZED toggle added to Settings. Minecraft-shader realism (sharp textures, no orange sunset). Rain & fog unchanged. Enjoy!")
